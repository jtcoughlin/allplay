...
class BrokenPosterFixer {
  private staticMappings: StaticMapping[] = [
    {
      ...
      imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Fox_News_Channel_logo.svg/2560px-Fox_News_Channel_logo.svg.png",
      description: "FOX News branding"
    },
    {
      title: "Anderson Cooper 360°",
      imageUrl: "https://upload.wikimedia.org/wikipedia/commons/6/6d/CNN_International_logo.svg",
      description: "CNN branding"
    },
    {
      title: "30 for 30",
      imageUrl: "https://upload.wikimedia.org/wikipedia/en/7/7b/30for30_logo.jpg",
      description: "ESPN 30 for 30 logo"
    },
    {
      title: "College GameDay",
      imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/ESPN_wordmark.svg/2560px-ESPN_wordmark.svg.png",
    ...
    },
    {
      ...
      imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/CBS_logo.svg/2048px-CBS_logo.svg.png",
      description: "CBS branding"
    },
    {
      title: "ABC World News Tonight",
      imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/ABC-2021-LOGO.svg/2560px-ABC-2021-LOGO.svg.png",
      description: "ABC branding"
    },
    {
      title: "NBC Nightly News",
      imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/NBC_logo.svg/2560px-NBC_logo.svg.png",
  ...
  private findStaticMapping(title: string): StaticMapping | null {
    ...
    const partialMatch = this.staticMappings.find(
      mapping => title.toLowerCase().includes(mapping.title.toLowerCase())
    );
  ...
  async fixBrokenPosters(): Promise<void> {
    ...
    console.log('Scanning database for invalid image URLs and applying static mappings...\n');
    ...
    try {
      ...
      for (const item of allContent) {
        ...
        if (checkedCount % 50 === 0) {
          console.log(`   Progress: ${checkedCount}/${allContent.length} items checked...`);
        }
      ...
      console.log(`   ✅ Success rate: ${updatedCount > 0 ? ((updatedCount / brokenCount) * 100).toFixed(1) + '%' : 'N/A'}`);
      ...
      if (updatedCount === 0) {
        ...
        console.log('   All updated items are now locked to prevent future quality regressions.');
      }
